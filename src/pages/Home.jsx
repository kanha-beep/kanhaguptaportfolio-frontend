...
const heroDockItems = [
  ...
  { label: "Blog", icon: "📄", to: "/blogs" },
  { label: "GitHub", icon: "🐙", href: siteContent.github },
...
export default function Home() {
  ...
  return (
    <main className="layout section-space">
                ...
                {heroDockItems.map((item, index) =>
                  item.to ? (
                    <Link
                      ...
                      className={`hero-dock-button ${index === 0 ? "hero-dock-button-active" : ""}`}
                    >
                      {item.icon}
                    </Link>
                  ) : (
      ...
      <MotionReveal className="mt-15" duration={1}>
        <section>
